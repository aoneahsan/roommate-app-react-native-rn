...
import { ZBox, ZPage } from "zaions-react-ui-kit";
    ...
    <>
      <ZPage>
        ...
        <ZBox className="flex w-full h-[calc(100vh-3.3125rem)]">
          ...
          <ZBox className="relative flex-1 h-full px-2 py-4 overflow-x-hidden overflow-y-auto 2xl:px-5 z_pretty_scrollbar">
            <svg
              width="2560"
            ...
            >
              <g>
                ...
                <path
                  ...
                  fill="url(#paint4_radial_37_453-4)"
                ></path>
              </g>
              <defs>
                <radialGradient
